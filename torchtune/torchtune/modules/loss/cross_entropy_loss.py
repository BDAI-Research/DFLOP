...
class LinearCrossEntropyLoss(nn.Module, SFTLoss):
    ...
    def compute_cross_entropy(
        ...
        """
        # print("[0] In compute cross entropy, hidden_chunk shape:", hidden_chunk.shape)
        # print("[0] In compute cross entropy, target_chunk shape:", target_chunk.shape)
        ...
        # print("[1] In compute cross entropy, target_chunk shape:", target_chunk.shape)
        ...
        # print("[2] In compute cross entropy, hidden_chunk shape:", hidden_chunk.shape)
        ...
        # print("[3] In compute cross entropy, logits shape:", logits.shape)
        if isinstance(logits, DTensor):
            logits = logits.full_tensor()
        # print("logits shape:", logits.shape, "target_chunk shape:", target_chunk.shape)
    ...
    def forward(
        ...
        for idx in range(len(hidden_chunks)):
            # print("hidden_chunk shape:", hidden_chunks[idx].shape, 
            #       "target_chunk shape:", target_chunks[idx].shape)
